...
| 006 | Add a live `clockify_doctor` connection-check tool (key/workspace/base-url/clock + per-failure remediation) | P2 | M | — | DONE (2026-06-26; historical count change was 134→135; use current `AGENTS.md` for today's count) |
...
| 009 | First-run onboarding — server `instructions` + `clockify-getting-started` prompt + status nudge | P2 | S | — | DONE (2026-06-26; historical prompt-count note only; use current `AGENTS.md` for today's count) |
| 010 | Nominative positioning page + visual quickstart (docs only) | P3 | S | — | DONE (2026-06-26; historical positioning work; current media/readiness truth lives in `mcp/POSITIONING.md`) |
