...
describe("MCP tool risk registry", () => {
    it("classifies exactly the live 141-tool surface once", () => {
        ...
        expect(governedNames).toHaveLength(141);
        expect(new Set(governedNames).size).toBe(141);
    });

    it("pins the six required risk totals and 56 guarded tools", () => {
