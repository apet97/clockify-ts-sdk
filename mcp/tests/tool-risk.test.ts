...
describe("MCP tool risk registry", () => {
    it("classifies exactly the live 144-tool surface once", () => {
        ...
        expect(governedNames).toHaveLength(144);
        expect(new Set(governedNames).size).toBe(144);
    });

    it("pins the six required risk totals and 59 guarded tools", () => {
