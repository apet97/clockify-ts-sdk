...
const workflows: GuardCase[] = [
    ...
    { tool: "clockify_schedule_work", group: "scheduling", method: "createRecurring", args: { user_id: id(25), project_id: id(26), start: "2026-07-01T00:00:00.000Z", end: "2026-07-02T00:00:00.000Z", hours_per_day: 8 }, echo: { projectId: id(26) } },
