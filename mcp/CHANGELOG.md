...
## [0.6.2](https://github.com/apet97/clockify-ts-sdk/compare/mcp-v0.6.6...mcp-v0.6.2) (2026-07-23)
...
* **mcp:** add a clockify://guide/which-tool decision-tree resource ([4f1c5b8](https://github.com/apet97/clockify-ts-sdk/commit/4f1c5b80c63b517962e35a65e8050c183dc5c55c))
* **mcp:** add approvals/import/mark-invoiced tools ([24a779e](https://github.com/apet97/clockify-ts-sdk/commit/24a779ef003aba55da34993c363ca35d58ea9370))
* **mcp:** add expense create/update tools ([859949d](https://github.com/apet97/clockify-ts-sdk/commit/859949d5cb0c78462d7c90951b5f52d6e4cd8878))
* **mcp:** add experimental entity change feed ([b0ec918](https://github.com/apet97/clockify-ts-sdk/commit/b0ec918885854f2b6f3ab6f1afcc3140488c48d0))
* **mcp:** add guarded scheduling copy ([7492031](https://github.com/apet97/clockify-ts-sdk/commit/7492031b71f7aaa18b4b1a34555318f88f7ade69))
* **mcp:** add live clockify_doctor connection-check tool (134-&gt;135) ([89d71fc](https://github.com/apet97/clockify-ts-sdk/commit/89d71fc41caa7b0e6b619a77abf925a65f2bbaf9))
* **mcp:** add one-click MCPB install bundle + flagship roadmap ([775f6ab](https://github.com/apet97/clockify-ts-sdk/commit/775f6abf630b98ed9f385e52356e3eb004909593))
* **mcp:** add project membership administration ([71d6fd9](https://github.com/apet97/clockify-ts-sdk/commit/71d6fd946f366d71f174e24b1edce7a7c48406ba))
* **mcp:** add reports tools (summary, detailed, weekly, attendance) ([cb12f0f](https://github.com/apet97/clockify-ts-sdk/commit/cb12f0f88922737d0b7113ffd4db0dedea7de654))
* **mcp:** add users/roles tools with generated SDK methods ([6f31951](https://github.com/apet97/clockify-ts-sdk/commit/6f31951b5e1bea5db596a84e5e0d1e8b490aefe4))
* **mcp:** adjust time-off balances ([444b0d2](https://github.com/apet97/clockify-ts-sdk/commit/444b0d2d9b31553833cc52bc513d945016627604))
* **mcp:** administer workspace user status ([aa82bf2](https://github.com/apet97/clockify-ts-sdk/commit/aa82bf2ee8932b625bce1650e165e63c5ba869f0))
...
* **mcp:** arg-shape forgiveness (zStringList/zNumberLike) + did-you-mean ([cf4f87f](https://github.com/apet97/clockify-ts-sdk/commit/cf4f87fbae8d99712416d6c15c43ec1198a17f2c))
* **mcp:** complete scheduling tools (publish, capacity) ([f3d28b0](https://github.com/apet97/clockify-ts-sdk/commit/f3d28b0e0f13bd566026f27ae319fc670e973254))
* **mcp:** diagnose webhook delivery status ([d4621bc](https://github.com/apet97/clockify-ts-sdk/commit/d4621bc067621fb43e4f48d240a642cf07bfd6e7))
* **mcp:** emit clarification receipts on ambiguous name resolution ([e6c66c6](https://github.com/apet97/clockify-ts-sdk/commit/e6c66c6805eb7ed06bc0a32f851c9f3f39750a24))
* **mcp:** first-run onboarding + nominative positioning page ([0cb1e86](https://github.com/apet97/clockify-ts-sdk/commit/0cb1e86532e1057471a866580e8c89cac4f2f33a))
* **mcp:** generate structural tool manifest ([6f27f56](https://github.com/apet97/clockify-ts-sdk/commit/6f27f568a1ce5fc66ca2c3c88093ecae905b2fab))
...
* **mcp:** live-verified write paths + set-rate tools (126-tool surface) ([fa7f52c](https://github.com/apet97/clockify-ts-sdk/commit/fa7f52c71109fd60732e01acd83bbaa6bfa79777))
...
* **mcp:** surface 7 missing-op tools — shared reports, user invite, member-profile update (P1-7); 127→134 ([fb680d2](https://github.com/apet97/clockify-ts-sdk/commit/fb680d2906adf71437b3e061c52342df483dc11a))
...
* **sdk,mcp:** add compose subpath + transactional createWorkPackage (P1-2); 25→26 subpaths ([48ae8ad](https://github.com/apet97/clockify-ts-sdk/commit/48ae8ad3b1932bcf9b8a9fba1d548c3678179188))
* **sdk,mcp:** fix SDK snippets and curate root exports ([4ade140](https://github.com/apet97/clockify-ts-sdk/commit/4ade1400840c6039ae48f2874d283d526e3aa485))
* **ws3:** add replay-fixtures live-fidelity gate ([21a3f17](https://github.com/apet97/clockify-ts-sdk/commit/21a3f175af88e32f7798f90f8a8d84682b143c3c))
...
* bound expense continuation scans ([0f96f44](https://github.com/apet97/clockify-ts-sdk/commit/0f96f4472293fad07b3556a622d8cce7aff62626))
* **ci:** aggregate governed MCP mutation suites ([ffbce7d](https://github.com/apet97/clockify-ts-sdk/commit/ffbce7dc1b18a792444a9ce485fc4d4dcbf71c17))
* **ci:** build SDK before MCP mutation ([9dd3d00](https://github.com/apet97/clockify-ts-sdk/commit/9dd3d00ae04375b6e470491255fcff77df69a25a))
* **ci:** generate runtime versions before mutation ([6181a5b](https://github.com/apet97/clockify-ts-sdk/commit/6181a5b14048e12892f047540c9da64bd6640d73))
* **ci:** let in-place mutation discover tests ([b526a23](https://github.com/apet97/clockify-ts-sdk/commit/b526a23e93a6b40b690940993923e26195347248))
* **ci:** pin MCP mutation test inventory ([946d587](https://github.com/apet97/clockify-ts-sdk/commit/946d587971d544ca8cb1633180485a3a013e8713))
* **ci:** run mutation on pinned Node 24 LTS ([5fd0689](https://github.com/apet97/clockify-ts-sdk/commit/5fd0689b64716f9924fe95f061ececda445c528e))
* **ci:** use aggregate mutation coverage ([a48c46f](https://github.com/apet97/clockify-ts-sdk/commit/a48c46f1479cfa95e6ea49d53e001150273fa71c))
...
* **gates:** close cast-budget review bypasses ([d42547a](https://github.com/apet97/clockify-ts-sdk/commit/d42547ae221f9d284aa8708e5a6a5befb4a34c91))
* **gates:** enforce zero request casts ([b1b4258](https://github.com/apet97/clockify-ts-sdk/commit/b1b425890b3e1ba6588daa56c53cc84cae66fb15))
...
* **mcp:** archive/DONE-then-delete for active projects + tasks (live-verified) ([3644057](https://github.com/apet97/clockify-ts-sdk/commit/36440575adf5a47f21f5b0507e80ea6c89f9dda5))
* **mcp:** clockify_groups_get reads from the list (generated get is void) ([0c0b5dc](https://github.com/apet97/clockify-ts-sdk/commit/0c0b5dcbaae8bea5aeee5869cf7393c4c1c67925))
* **mcp:** conform tools to the official Clockify OpenAPI (invalid enums, dead routes) ([8953710](https://github.com/apet97/clockify-ts-sdk/commit/895371063a9dc6e890d9d5727ea29be50a890c79))
* **mcp:** conformance + receipt + pagination fixes across domain/workflow tools ([1d1634c](https://github.com/apet97/clockify-ts-sdk/commit/1d1634c81cf72dceecdc536ccabc5780e0534d30))
* **mcp:** forward scheduling start/end + unwrap category envelope; consume spec re-snapshot ([a4e18a0](https://github.com/apet97/clockify-ts-sdk/commit/a4e18a000f8fb519d7462ab5e7becb055ba70a51))
* **mcp:** harden project membership confirmation ([691ab45](https://github.com/apet97/clockify-ts-sdk/commit/691ab45f5b8ec90659d3366fb154f0127d575ed4))
* **mcp:** normalize expense date to RFC3339 in create/update domain tools ([01c9061](https://github.com/apet97/clockify-ts-sdk/commit/01c90617b5d73060c54b0f715c6b269ab521ec97))
* **mcp:** omit empty scheduling copy receipt ([d89a0d3](https://github.com/apet97/clockify-ts-sdk/commit/d89a0d390afef695d636009318484ffcb7059136))
* **mcp:** P2-1 trap-cast sites — live-probed corrections ([f770b50](https://github.com/apet97/clockify-ts-sdk/commit/f770b5045a7a20a9265eb97f826eb9a89e72cff4))
* **mcp:** publish 0.6.4 via governed release audit ([60fb43c](https://github.com/apet97/clockify-ts-sdk/commit/60fb43c7441a94e47b98679d9a72ea3f8379cac8))
* **mcp:** redact webhook authToken in setup_webhook + send invoiceStatus wire field ([2b17598](https://github.com/apet97/clockify-ts-sdk/commit/2b17598ef2ae6b0ec9f05902b6f9fad6372702fe))
* **mcp:** remove the last allow_overlap leftover in sandbox.test.ts ([18612d6](https://github.com/apet97/clockify-ts-sdk/commit/18612d6ed54d3a085e5990fa47a689b8d088155b))
* **mcp:** require dry_run-&gt;confirm_token for all destructive domain deletes ([c6ba09f](https://github.com/apet97/clockify-ts-sdk/commit/c6ba09f52a8f14c99e72c9c82e3b434eb2c23558))
* **mcp:** require name on clockify_webhooks_create (spec-faithful 2-30) ([280309f](https://github.com/apet97/clockify-ts-sdk/commit/280309f4500fbfc904396a377b3ff5a9b2492892))
* **mcp:** require structuredContent.ok in isCallToolResult ([2b96602](https://github.com/apet97/clockify-ts-sdk/commit/2b966028e0f96e26514cac5d83ac8c9925f2ddf4))
* **mcp:** resolve name-&gt;id in holidays/timeOff/scheduling/groups/users tools before write ([6e501e4](https://github.com/apet97/clockify-ts-sdk/commit/6e501e4b07f1635d569bf0f13bf527032074193e))
* **mcp:** resolve time-off status-note cast via live probe (note is optional) ([116b191](https://github.com/apet97/clockify-ts-sdk/commit/116b191a4d0613e75e619dbf842e70283484d83f))
* **mcp:** ship 0.6.5 with governed MCPB audit ([40161ae](https://github.com/apet97/clockify-ts-sdk/commit/40161ae47a89257e87212ee3148bb0304a9ba184))
* **mcp:** stable confirm-preview date, coerce rate amounts, timer_start receipt ([544555e](https://github.com/apet97/clockify-ts-sdk/commit/544555e9a8d9383e307d1667aed2898507347a78))
* **mcp:** time_off_requests_get scans the POST search (dead 404 single-GET) ([faf7a18](https://github.com/apet97/clockify-ts-sdk/commit/faf7a182f732bca4c08415b06e3fe5e042a9ce44))
* **mcp:** time-off DAYS policy, redact webhook authToken, bound iterAll ([8647f0a](https://github.com/apet97/clockify-ts-sdk/commit/8647f0ad4c3adbf3f3dc389a69232356b62db2ac))
* **mcp:** time-off request delete uses the policy-scoped withdraw route ([3bfe408](https://github.com/apet97/clockify-ts-sdk/commit/3bfe408be64c5599f3ee77a4e758cbcffaa26d23))
* **mcp:** type listForUser workflows ([17aca0d](https://github.com/apet97/clockify-ts-sdk/commit/17aca0d3444f470545a214378c266e379ea69695))
* **mcp:** validate time-entry custom fields ([68df03e](https://github.com/apet97/clockify-ts-sdk/commit/68df03ef25140efc307ae5eecdf9858821dd3d46))
* preserve expense continuation records ([0daaf01](https://github.com/apet97/clockify-ts-sdk/commit/0daaf01e30708e2c30e29f7c134cb05dfd6583de))
...
* **roadmap-1.0:** governed npm audit gate for task 13 closure ([e105470](https://github.com/apet97/clockify-ts-sdk/commit/e1054701cd3216ffa54964bad8b179125a01f5a9))
* **scope:** time-off policies scope with status:ACTIVE (match live-verified addon) ([036fb15](https://github.com/apet97/clockify-ts-sdk/commit/036fb152b407a6cdf5bc43c9406b242ca70bb55a))
...
* **sdk,mcp:** P0 correctness — pagination, audit-log host, fix_entry task/tag, date validation ([7383e96](https://github.com/apet97/clockify-ts-sdk/commit/7383e966f97605eb91cf4371403da0ab5fe4ae0a))
...
* **mcp:** bound fix_entry history scan; paginate groups_get ([7ce5ed5](https://github.com/apet97/clockify-ts-sdk/commit/7ce5ed51bd3ac4b49cac7775335d5d576d9ad634))
