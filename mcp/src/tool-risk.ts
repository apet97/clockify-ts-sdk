...
export const TOOL_RISK_BY_NAME = {
    ...
    clockify_approvals_submit_for_user_with_type: "business_write",
    clockify_approvals_submit: "business_write",
    clockify_approvals_submit_with_type: "business_write",
    ...
    clockify_invoices_items_add: "business_write",
    clockify_invoices_items_delete: "destructive",
    clockify_invoices_info: "read",
    clockify_invoices_items_list: "read",
    clockify_invoices_list: "read",
    clockify_invoices_payments_create: "business_write",
    clockify_invoices_payments_delete: "destructive",
    ...
    clockify_projects_estimates_update: "business_write",
    ...
    clockify_projects_templates_list: "read",
    clockify_projects_templates_mark: "business_write",
    ...
    clockify_time_off_balance_assignments_create: "business_write",
    clockify_time_off_balance_assignments_delete: "destructive",
    clockify_time_off_balance_assignments_list: "read",
    clockify_time_off_balance_assignments_update: "business_write",
    ...
    clockify_time_off_requests_create_for_user: "business_write",
    ...
    clockify_workspace_settings: "read",
