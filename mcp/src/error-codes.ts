/* Generated by scripts/generate-error-docs.mjs. Edit docs/error-codes.json for the code registry, or this generator's typescriptFor() for the matcher functions, then run make error-docs. */
