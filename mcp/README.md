...
Current release: `0.6.4`. Requires Node.js `>=22.13.0` and
...
Download
[`clockify115-mcp-0.6.4.mcpb`](https://github.com/apet97/clockify-ts-sdk/releases/download/mcp-v0.6.4/clockify115-mcp-0.6.4.mcpb)
from the [`mcp-v0.6.4` release](https://github.com/apet97/clockify-ts-sdk/releases/tag/mcp-v0.6.4)
