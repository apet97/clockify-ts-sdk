...
export class FilesClient {
    ...
    /**
     * @param {ClockifyApi.UploadImageRequest} request
     ...
     */
    public uploadImage(
        request: ClockifyApi.UploadImageRequest,
        requestOptions?: FilesClient.RequestOptions,
    ): core.HttpResponsePromise<ClockifyApi.ImageUploadResponse> {
    ...
    private async __uploadImage(
        request: ClockifyApi.UploadImageRequest,
        requestOptions?: FilesClient.RequestOptions,
    ): Promise<core.WithRawResponse<ClockifyApi.ImageUploadResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as ClockifyApi.ImageUploadResponse, rawResponse: _response.rawResponse };
        }
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/file/image");
    }
}
