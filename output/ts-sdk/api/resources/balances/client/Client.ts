...
export class BalancesClient {
    ...
    /**
     * @param {ClockifyApi.GetWorkspacesWorkspaceIdBalanceRequest} request
     * @param {BalancesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     *     await client.balances.getWorkspacesWorkspaceIdBalance({
     *         workspaceId: "workspaceId"
     *     })
     */
    public getWorkspacesWorkspaceIdBalance(
        request: ClockifyApi.GetWorkspacesWorkspaceIdBalanceRequest,
        requestOptions?: BalancesClient.RequestOptions,
    ): core.HttpResponsePromise<ClockifyApi.Balance[]> {
        return core.HttpResponsePromise.fromPromise(this.__getWorkspacesWorkspaceIdBalance(request, requestOptions));
    }

    private async __getWorkspacesWorkspaceIdBalance(
        request: ClockifyApi.GetWorkspacesWorkspaceIdBalanceRequest,
        requestOptions?: BalancesClient.RequestOptions,
    ): Promise<core.WithRawResponse<ClockifyApi.Balance[]>> {
        const { workspaceId, policyId, userId } = request;
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `workspaces/${core.url.encodePathParam(workspaceId)}/balance`,
            ),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return { data: _response.body as ClockifyApi.Balance[], rawResponse: _response.rawResponse };
        }
    ...
    /**
     * @param {ClockifyApi.PatchWorkspacesWorkspaceIdBalanceRequest} request
     * @param {BalancesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     *     await client.balances.patchWorkspacesWorkspaceIdBalance({
     *         workspaceId: "workspaceId"
     *     })
     */
    public patchWorkspacesWorkspaceIdBalance(
        request: ClockifyApi.PatchWorkspacesWorkspaceIdBalanceRequest,
        requestOptions?: BalancesClient.RequestOptions,
    ): core.HttpResponsePromise<void> {
        return core.HttpResponsePromise.fromPromise(this.__patchWorkspacesWorkspaceIdBalance(request, requestOptions));
    }

    private async __patchWorkspacesWorkspaceIdBalance(
        request: ClockifyApi.PatchWorkspacesWorkspaceIdBalanceRequest,
        requestOptions?: BalancesClient.RequestOptions,
