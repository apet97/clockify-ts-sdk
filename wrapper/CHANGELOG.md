...
## [0.12.1](https://github.com/apet97/clockify-ts-sdk/compare/wrapper-v0.13.0...wrapper-v0.12.1) (2026-07-27)
...
* **errors:** map add-on-token 401 to a named restriction ([8f02822](https://github.com/apet97/clockify-ts-sdk/commit/8f0282207e7725fddf7fbe7aecabc016ada832fd))
* **gates:** pin README SDK snippets to compiled examples ([3e45462](https://github.com/apet97/clockify-ts-sdk/commit/3e454629328d01f12437cbbdbb4ed4d8b52c9d78))
* **gen:** emit EOPT- and override-clean SDK scaffold; enable both flags ([14a471a](https://github.com/apet97/clockify-ts-sdk/commit/14a471a074728efc643ee714d88d9b6a47be2734))
...
* **resolve:** port list/filter resolvers (users/groups/tags/user-filter) ([6a38aff](https://github.com/apet97/clockify-ts-sdk/commit/6a38affc4778bf7e8b3ab33b5f3a2c342b5bd03e))
* **roadmap-1.0:** task 14 wrapper authentication mutation scope ([98d67b4](https://github.com/apet97/clockify-ts-sdk/commit/98d67b472564232f2f319307819cd2f768af24b5))
* **roadmap-1.0:** task 8 authenticated-host equality ([00c53c9](https://github.com/apet97/clockify-ts-sdk/commit/00c53c9d3cda62f1898312171b3835273e8ebc5e))
...
* **sdk:** add reports + bulk subpaths (P3-2, P1-3) — 23→25 subpaths, 81→90 names ([b24286a](https://github.com/apet97/clockify-ts-sdk/commit/b24286a6179794bf43b728ed4f1c78acc957a7ee))
* **sdk:** add typed Clockify service routing ([49b872e](https://github.com/apet97/clockify-ts-sdk/commit/49b872e82332d1fb2745b4306abce963945713da))
* **sdk:** remove unsafe request body escape ([900da3a](https://github.com/apet97/clockify-ts-sdk/commit/900da3aa9f11cea8ab1a0c3a678954fcfc4ff2b0))
* **wrapper:** add resolve + dates name/calendar helper subpaths ([96975df](https://github.com/apet97/clockify-ts-sdk/commit/96975df44a2e11c92d22cb87d348163adeac3af7))
...
* **ci:** raise CJS root size-limit ceiling to 3 kB for new root re-exports ([e031922](https://github.com/apet97/clockify-ts-sdk/commit/e031922842e7c562c647594f45683c97a9e77c9d))
...
* **codegen:** disable mutation retries by default ([a3f8865](https://github.com/apet97/clockify-ts-sdk/commit/a3f8865fba5cf4e8f15b6cc36174fca60ec10a59))
* **docs:** broaden SDK snippet method parity ([912563a](https://github.com/apet97/clockify-ts-sdk/commit/912563a46c8d9fb178273717e983fbd279b0faac))
* enforce 1.0 migration proof ([5485a65](https://github.com/apet97/clockify-ts-sdk/commit/5485a65b33831c742f2d9dfe7eebcc4c164b6346))
...
* harden authenticated request execution ([83a0b5f](https://github.com/apet97/clockify-ts-sdk/commit/83a0b5f9e9e7b7c323edb00e3bdec4b805cd02c5))
* harden operation coverage proof ([1a6598e](https://github.com/apet97/clockify-ts-sdk/commit/1a6598e39ab95df555f73f26bf62a36c626183b5))
...
* make authenticated requests abort-safe ([2fe60ec](https://github.com/apet97/clockify-ts-sdk/commit/2fe60ec0181af794abd649c77d8a1c769eadf413))
...
* pin operation evidence semantics ([fb1c184](https://github.com/apet97/clockify-ts-sdk/commit/fb1c18420ee3d4bc67466c2aeee7d9d4239f0326))
...
* prove generated operation reachability ([8c1ca76](https://github.com/apet97/clockify-ts-sdk/commit/8c1ca763cde36f49eae6de7c92f27afe6e2ed92f))
...
* require complete operation evidence audit ([1a49d27](https://github.com/apet97/clockify-ts-sdk/commit/1a49d27976056660409ce03f6664338531de420e))
* restrict authenticated base URL schemes ([2d30f4e](https://github.com/apet97/clockify-ts-sdk/commit/2d30f4e881237439c70a77b72404b7a4495c8171))
...
* **sdk:** make retries read-only by default ([224f1e3](https://github.com/apet97/clockify-ts-sdk/commit/224f1e362659d4c019b2c3f89ab20eb43c48ba15))
* **sdk:** stop documenting routing as wired to request dispatch ([d2ff1ca](https://github.com/apet97/clockify-ts-sdk/commit/d2ff1ca2194a5c887630b7e6cfcdfb7a431d82f4))
...
* **spec,build:** restore Client.ccEmails/currencyId; add spec-parity gate; harden secret-hygiene; pin archive wire shape ([ee8f22f](https://github.com/apet97/clockify-ts-sdk/commit/ee8f22f0490a488772b348ba7e5b4a76dd5982e3))
...
* **test:** bind composed fetch mutation imports ([758be85](https://github.com/apet97/clockify-ts-sdk/commit/758be8590d8d0ea3af23e049b879ceb9cc599901))
* **test:** seed date properties without setup hooks ([fd546e3](https://github.com/apet97/clockify-ts-sdk/commit/fd546e364390b496f509be4d089013016b7a3096))
...
* **transport:** route and validate all Clockify services ([29e1b45](https://github.com/apet97/clockify-ts-sdk/commit/29e1b45a8282d3247b1285ec888cf32e057e57ff))
* validate replacement write state ([bd7a2c1](https://github.com/apet97/clockify-ts-sdk/commit/bd7a2c1bf708b10f72c5c2032f097af85b5d913f))
...
* **wrapper:** avoid dependency-boundary false-positive in sync-sdk.mjs comments ([513076a](https://github.com/apet97/clockify-ts-sdk/commit/513076a04f5d0027194fc8782502c724388c658b))
* **wrapper:** block multicast/reserved/broadcast hosts in webhook SSRF guard ([c2ff8aa](https://github.com/apet97/clockify-ts-sdk/commit/c2ff8aac3ed678598018c2c613a371f1208b4295))
* **wrapper:** block NAT64 SSRF bypass + correct false header-redaction docs ([177dd7e](https://github.com/apet97/clockify-ts-sdk/commit/177dd7eff797ff1a494d4a422c7240f6144af986))
* **wrapper:** deterministic UTC resolveInstant, SSRF v6-embedding guards, otel span key ([3352e48](https://github.com/apet97/clockify-ts-sdk/commit/3352e48451841dd37e9197291112d5326fd78b4d))
* **wrapper:** fail-fast bulk run and block auth-header redirects ([c5ec33a](https://github.com/apet97/clockify-ts-sdk/commit/c5ec33a77dbf4cccd599afcaa0ffea66cc10d94a))
* **wrapper:** re-pin the pack snapshot to the routing emissions ([356617d](https://github.com/apet97/clockify-ts-sdk/commit/356617dc46558db49933be70e38dd036db2e7449))
* **wrapper:** remove stale scoped-client casts ([b72378b](https://github.com/apet97/clockify-ts-sdk/commit/b72378bcbff707baa65dcdc2e78f26fa3da74467))
* **wrapper:** synchronize generated SDK atomically ([50c4f70](https://github.com/apet97/clockify-ts-sdk/commit/50c4f70c0810068dfb052716fdc2e4a80455e342))
