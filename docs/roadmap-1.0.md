...
| 20. Unique-claim inventory | 19 | implemented (0/2 approvals) | `docs/roadmap-1.0-receipts/task-20-unique-claims.md` | `make docs-drift docs-quality`; `docs/roadmap-1.0-receipts/task-20-unique-claims.md` | Yes |
...
a non-blocking risk; Task 19 is complete and Task 20 is next, while Task 1 and
