...
|---|---|---|---|---|---|
| 1. Truthful readiness baseline | — | evidence_captured (0/2 approvals) | exact closure command returned `exit 0` at `99f2f2f2ccfd98d3f55b05c500ed4e789d746148`; evidence recorded in `docs/roadmap-1.0-receipts/task-01-approvals.md`; two independent approvals remain | `make risk-register risk-status-report release-readiness contract-gates`; `docs/roadmap-1.0-receipts/task-01-approvals.md` records two independent approvals naming the resolved pre-close head and full `ec68c61..<pre-close-HEAD>` range plus the evidence-only closeout | Yes |
