...
| 24. Time-off balance adjustment | 23 | pending | no Task 24 implementation evidence recorded | `npm test -w @apet97/clockify-mcp-115`; `docs/roadmap-1.0-receipts/task-24-time-off-balance.md` | No — post-baseline workflow scope |
