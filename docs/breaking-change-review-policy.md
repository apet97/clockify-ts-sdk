...
| OpenAPI/generator | Operation ID, SDK method stamp, pagination stamp, Last-Page stamp, corrected snapshot, local generator (`scripts/generate-sdk-from-openapi.mjs`) behavior, or generated output location changes. | GOCLMCP source/generator change, discrepancy evidence, generator comparison, operation coverage, and drift gates. |
