...
For the completed historical 1.0 campaign, `docs/risk-register.json` currently reports zero required open final-readiness blockers. If a future blocker is open, the risk
