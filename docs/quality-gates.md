...
| Run governed live-evidence campaign | `make live-evidence-campaign` | Rebuilds the SDK offline, runs the credentialed 163-operation campaign from an immutable content snapshot, proves final cleanup, and emits hash-bound candidates for separate human approval. |
