...
| Live proof | Live tests mutate a customer workspace or leave sandbox records behind. | Require explicit live env vars, sacrificial workspace only, timestamped prefixes, paired cleanup, and final cleanup receipts. | `make live-safety`, `make perfect-live` |
