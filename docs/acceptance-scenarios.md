...
| OpenAPI truth and generated core | 169 receipt-derived generated SDK methods behind durable wrapper seams (155 explicit + 14 governed operationId-derived) | CLI uses wrapper semantics instead of inventing API truth | MCP uses wrapper semantics and parity metadata | GOCLMCP drift gates, local codegen drift and local codegen receipt, all-operation dispositions, operation coverage, generator comparison, and generated-edit guard. |
