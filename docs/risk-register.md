...
| `operation-parity-generated-reachability` | `accepted` | Generated operation parity | All 169 operations are receipt-derived and disposed exactly once: 155 explicitly named + 14 governed operationId-derived. | Closed 2026-07-19 by receipt-derived 169/155/14 parity, all-operation dispositions, fail-closed fixture tests, `make sdk-codegen sdk-codegen-drift sdk-codegen-test generator-comparison operation-parity operation-parity-drift`, `make risk-register contract-gates`, and `docs/roadmap-1.0-receipts/task-05-generated-reachability.md`. |
