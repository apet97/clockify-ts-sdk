...
| `mcp/` / `@apet97/clockify-mcp-115` | Agent-facing Clockify workflows | Workflow-first tools, 146 advertised tools, rich result envelopes, recovery hints, dry-run confirmation tokens, and clean live sandbox cleanup. |
