...
| [`release-decision.md`](./release-decision.md) / [`one-point-zero-surface-inventory.md`](./one-point-zero-surface-inventory.md) | Current release decision, mechanical 1.0 surface evidence, registry receipt, exact-artifact proof boundary, and deferred 1.x posture. |
