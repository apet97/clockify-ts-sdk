...
| [`operation-dispositions.json`](./operation-dispositions.json) | `make operation-parity` | All 175 operations mapped to codegen-receipt reachability, naming class, and evidence identifiers. |
...
| [`operation-evidence-map.json`](./operation-evidence-map.json) | `make operation-parity` | Derived 175-row evidence audit with applicable anchors or an explicit audited-no-applicable-evidence reason. |
| [`sdk-operation-naming-classifications.json`](./sdk-operation-naming-classifications.json) | edit intentionally | Governed registry for the exact 26 operationId-derived generated methods. |
...
| Live-evidence campaign | `make live-evidence-campaign` | Rebuild and execute the content-snapshotted 175-operation sandbox campaign, producing ignored candidates for separate exact-hash approval and import. |
