...
| [`gate-tier-inventory.md`](./gate-tier-inventory.md) / [`gate-tier-inventory.json`](./gate-tier-inventory.json) | Generated direct `contract-gates` prerequisite graph and D4 tier-decision packet. |
...
| [`operation-evidence-map.json`](./operation-evidence-map.json) | `make operation-parity` | Derived 169-row evidence audit with applicable anchors or an explicit audited-no-applicable-evidence reason. |
...
| [`gate-tier-inventory.json`](./gate-tier-inventory.json) / [`gate-tier-inventory.md`](./gate-tier-inventory.md) | `make gate-tier-inventory` | Generated direct and transitive `contract-gates` proof inventory; every proposed tier must be reviewed before gate simplification. |
