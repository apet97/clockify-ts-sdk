...
perfect-fast: mcp-write-safety generator-comparison config-precedence cli-contract mcp-contract runtime-support package-contract version-consistency changelog-drift docs-index-drift agent-handoff ci-contract
...
perfect-full: mcp-write-safety generator-comparison config-precedence cli-contract mcp-contract runtime-support package-contract version-consistency changelog-drift docs-index-drift agent-handoff mutation-ci ci-contract
