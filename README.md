...
| `@clockify115/mcp-server` | v0.3.0; 112 stdio MCP tools: 20 workflow/orientation tools plus 92 domain tools, rich `changed`/`next` envelopes, stable recovery errors, dry-run confirmation tokens |
