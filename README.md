...
|---|---|---|
| `clockify-sdk-ts-115` | 1.0.0 | 29 resource modules, 163 generated operations (149 explicit + 14 operationId-derived), dual ESM/CJS, typed multi-service routing, pagination, webhook verification, typed errors, scoped clients, OTel/health/rate-limit helpers, name/date resolution |
