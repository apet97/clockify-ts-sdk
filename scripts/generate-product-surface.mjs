...
const workflows = [
    ...
    },
    {
        ...
        proof: ["scripts/live/orchestrator.mjs", "scripts/live/cleanup.mjs", "../GOCLMCP/docs/live-tests.md"],
        surfaceAvailability: {
        ...
        proofMode: "aggregate live orchestrator plus dependency-ordered cleanup and zero-leftover receipt",
