...
const task17Contract = Object.freeze({
    status: "floor-ratchet-awaiting-final-remote-proof",
    ...
    next: "Controller must dispatch a final floor-bearing Mutation target=cli run; its receipt, two independent approvals, and the Task 18 aggregate proof remain pending.",
    remoteMeasurement: {
...
const remoteMutationProofContract = Object.freeze({
    status: "partial-wrapper-and-mcp-individual-proofs-recorded-cli-floor-ratchet-awaiting-final-remote-proof-and-aggregate-approved-target-proof-incomplete",
