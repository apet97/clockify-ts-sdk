...
function validateContractShape() {
  ...
  for (const invariant of [
    ...
    "valid-purpose",
    "safe-mcp-agent-ux-paths",
    "typed-tools-metadata-reference",
    "typed-expected-tool-summary",
    "typed-agent-ux-checks",
    "typed-wiring-contract",
  ]) {
    if (!invariants.includes(invariant)) errors.push(`contractInvariants: missing ${invariant}`);
  }
