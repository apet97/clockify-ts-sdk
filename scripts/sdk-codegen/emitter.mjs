...
async function writeCore(outDir) {
    ...
    // barrel re-exports (verified 2026-08-07; see docs finding F8/audit W-09).
    // core/file/{index,exports}.ts IS kept: api/resources/index.ts imports
    // `Uploadable` from it for the file-upload operation.
