...
// W5/W5-fix: withoutGoMcpProvenance lives in ./lib/operation-parity-provenance.mjs
// so its drift-comparison behavior is directly unit-testable (see
// generate-operation-parity.test.mjs) without staging this generator's full
// input set. See that module for the catalogPresent/carriedForward/
// carriedFromVerifiedAt rationale.
