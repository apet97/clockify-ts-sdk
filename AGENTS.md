...
wrapper/src/**  (gitignored; populated by sync)
        ...
        │  npm run build:smoke   (verifies ESM + CJS expose 81 names + 23 subpaths;
...
│   ├── verify-dual-build.sh  ← smoke: both ESM + CJS imports against dist/ (81 names, 23 subpaths @ v0.9.0)
