...
wrapper/src/**  (gitignored; populated by sync)
        ...
        │  npm run build:smoke   (verifies ESM + CJS expose 90 names + 25 subpaths;
...
│   ├── verify-dual-build.sh  ← smoke: both ESM + CJS imports against dist/ (90 names, 25 subpaths @ v0.9.0)
