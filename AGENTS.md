...
wrapper/src/**  (gitignored; populated by sync)
        ...
        │  npm run build:smoke   (verifies ESM + CJS expose 79 names + 23 subpaths;
...
│   ├── verify-dual-build.sh  ← smoke: both ESM + CJS imports against dist/ (79 names, 23 subpaths @ v0.9.0)
