...
- **Coordinated package truth:** the SDK is `0.12.2`, the CLI is `0.3.2`, and the
  TypeScript MCP is `0.6.4`. `version-consistency` reconciles all three package
...
| `mcp/` | `@apet97/clockify-mcp-115` | v0.6.4 stdio MCP; bin `clockify115-mcp`; tool/resource counts are generated into the product surface |
